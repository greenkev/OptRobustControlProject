...
y0 = deg2rad( [0;0;0;0]); %Initial Condition
controller = getLQRTrackingControl([0 0 0 0]', p); %Controller Handle
...
animObj.animateTraj(deg2rad(y(1:decimation:end,:)),'LQR Tracking Nonlinear System')
pause(1);
animObj.animateTraj(deg2rad(y_lin(1:decimation:end,:)),'LQR Tracking Linear System')